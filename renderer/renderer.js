...
function buildPrimaryCardHTML(match, matchDate) {
  ...
  html += '<span class="team-block home">';
  if (match.homeLogo) html += '<img class="team-crest" src="' + escapeHTML(match.homeLogo) + '" alt="" />';
  html += '<span class="team-name">' + escapeHTML(match.homeTeam.toUpperCase()) + '</span>';
  html += '</span>';
  html += '<span class="vs-label">VS</span>';
  html += '<span class="team-block away">';
  if (match.awayLogo) html += '<img class="team-crest" src="' + escapeHTML(match.awayLogo) + '" alt="" />';
  html += '<span class="team-name">' + escapeHTML(match.awayTeam.toUpperCase()) + '</span>';
  html += '</span>';
  html += '</div>';
